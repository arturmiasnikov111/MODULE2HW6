...
namespace MODULE2HW6.Models.ASegmentCar.ASegmentToyota.ToyotaAygo
{
    public class ToyotaAygo : ASegmentToyota
    {
        public ToyotaAygo(Weight weight, CarColorEnum color, ManufacturerCountryEnum country, TransmissionEnum transmission, double seats, Price price, BrandEnum brand, int carSpeed, int fuelConsumption)
        {
            Weight = weight;
            Color = color;
        ...
        public override string ToyotaBrand { get; set; } = nameof(ToyotaAygo);
